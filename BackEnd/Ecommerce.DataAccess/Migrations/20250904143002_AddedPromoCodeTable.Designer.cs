...
namespace Ecommerce.DataAccess.Migrations
{
    ...
    [Migration("20250904143002_AddedPromoCodeTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Entities.Models.PromoCode", b =>
                {
                    ...
                    b.HasIndex("IsDeleted", "StartAt", "EndAt")
                        .HasDatabaseName("IX_PromoCodes_Active_DateRange");

                    b.ToTable("PromoCodes", null, t =>
                        {
                            t.HasCheckConstraint("CK_PromoCode_DateRange", "EndAt > StartAt");

                            t.HasCheckConstraint("CK_PromoCode_DiscountPercentage", "DiscountPercentage >= 0 AND DiscountPercentage <= 100");
                        });
                });
